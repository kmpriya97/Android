package com.ixm.storehere.database;
...
import com.ixm.storehere.view.NotesAdapter;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long insertNote(String note, String timestamp, String title) {
    ...
    public Note getNotes(long id) {
        ...
        Cursor cursor = db.query( Note.TABLE_NAME,
                new String[]{Note.COLUMN_ID, Note.COLUMN_NOTE, Note.COLUMN_TIMESTAMP, Note.COLUMN_TITLE},
                Note.COLUMN_ID + "=?",
    ...
    public int getNotesCount() {
        ...
        Log.i( "getNotesCount", "getNotesCount: " + count );
        cursor.close();
